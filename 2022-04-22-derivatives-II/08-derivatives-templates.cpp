...
double deriv_richardson(double x, double h, int order, func_t fun, alg_t alg);
...
int main(void)
{
  ...
  for (int ii = 1; ii <= 10; ii++) {
    ...
    drf = deriv_richardson(x, h, 1, f, forward_deriv);
    drc = deriv_richardson(x, h, 2, f, central_deriv);
